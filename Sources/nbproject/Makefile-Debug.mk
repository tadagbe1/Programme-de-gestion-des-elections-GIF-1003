...
${OBJECTDIR}/Candidat.o: Candidat.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Candidat.o Candidat.cpp

${OBJECTDIR}/Circonscription.o: Circonscription.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Circonscription.o Circonscription.cpp
...
${OBJECTDIR}/Electeur.o: Electeur.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Electeur.o Electeur.cpp
...
${OBJECTDIR}/PersonneAbsenteException.o: PersonneAbsenteException.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PersonneAbsenteException.o PersonneAbsenteException.cpp

${OBJECTDIR}/PersonneDejaPresenteException.o: PersonneDejaPresenteException.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PersonneDejaPresenteException.o PersonneDejaPresenteException.cpp

${OBJECTDIR}/PersonneException.o: PersonneException.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PersonneException.o PersonneException.cpp
...
${TESTDIR}/TestFiles/f2: ${TESTDIR}/tests/CandidatTesteur.o ${OBJECTFILES:%.o=%_nomain.o}
	...
	${LINK.cc} -o ${TESTDIR}/TestFiles/f2 $^ ${LDLIBSOPTIONS}   -lgtest -lgtest_main -lpthread 

${TESTDIR}/TestFiles/f4: ${TESTDIR}/tests/CirconscriptionTesteur.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc} -o ${TESTDIR}/TestFiles/f4 $^ ${LDLIBSOPTIONS}   -lgtest -lgtest_main -lpthread 

${TESTDIR}/TestFiles/f3: ${TESTDIR}/tests/ElecteurTesteur.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc} -o ${TESTDIR}/TestFiles/f3 $^ ${LDLIBSOPTIONS}   -lgtest -lgtest_main -lpthread 
...
${TESTDIR}/tests/CandidatTesteur.o: tests/CandidatTesteur.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/src/gtest/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/CandidatTesteur.o tests/CandidatTesteur.cpp


${TESTDIR}/tests/CirconscriptionTesteur.o: tests/CirconscriptionTesteur.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/src/gtest/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/CirconscriptionTesteur.o tests/CirconscriptionTesteur.cpp


${TESTDIR}/tests/ElecteurTesteur.o: tests/ElecteurTesteur.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/src/gtest/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ElecteurTesteur.o tests/ElecteurTesteur.cpp
...
${OBJECTDIR}/Candidat_nomain.o: ${OBJECTDIR}/Candidat.o Candidat.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Candidat_nomain.o Candidat.cpp;\
	else  \
...
${OBJECTDIR}/Circonscription_nomain.o: ${OBJECTDIR}/Circonscription.o Circonscription.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Circonscription_nomain.o Circonscription.cpp;\
	else  \
...
${OBJECTDIR}/Electeur_nomain.o: ${OBJECTDIR}/Electeur.o Electeur.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Electeur_nomain.o Electeur.cpp;\
	else  \
...
${OBJECTDIR}/PersonneAbsenteException_nomain.o: ${OBJECTDIR}/PersonneAbsenteException.o PersonneAbsenteException.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PersonneAbsenteException_nomain.o PersonneAbsenteException.cpp;\
	else  \
...
${OBJECTDIR}/PersonneDejaPresenteException_nomain.o: ${OBJECTDIR}/PersonneDejaPresenteException.o PersonneDejaPresenteException.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PersonneDejaPresenteException_nomain.o PersonneDejaPresenteException.cpp;\
	else  \
...
${OBJECTDIR}/PersonneException_nomain.o: ${OBJECTDIR}/PersonneException.o PersonneException.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PersonneException_nomain.o PersonneException.cpp;\
	else  \
